...
export interface ComponentProps {
     ...
     *
     * Accepts a number between 0 and 4.
     * @default 1
     */
    speed: number;
    /**
...
export declare const heatmapShadow: import('typegpu').TgpuFn<(a: d.F32, b: d.F32, tk: d.F32, phase: d.F32) => d.F32>;
export declare const heatmapHeatField: import('typegpu').TgpuFn<(fieldRaw: d.F32, sdfUV: d.Vec2f, animTime: d.F32, p0: d.Vec4f, scale: d.F32) => d.F32>;
export declare const heatmapCompose: import('typegpu').TgpuFn<(heat: d.F32, ramp: d.Vec4f) => d.Vec4f>;
