 ...
 */
export type PropUIType = 'text' | 'number' | 'range' | 'color' | 'checkbox' | 'select' | 'origin' | 'position' | 'image-upload' | 'video-upload' | 'map' | 'shape' | 'shape3d' | 'gradient-stops' | 'font-family' | 'font-weight';
/**
