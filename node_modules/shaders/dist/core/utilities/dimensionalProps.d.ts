import { BoundingBoxDeclaration, BoundingBoxOrigin, ComponentDefinition, DimensionalValue } from '../types';

export declare function setShaderCanvasDimensions(width: number, height: number): void;
export declare function getShaderCanvasDimensions(): {
    width: number;
    height: number;
};
export declare function isDimensionalValue(v: any): v is DimensionalValue;
 ...
 */
export declare function buildExtraSizeProps(props: Record<string, {
    ui?: {
        dimensional?: SizeConversion;
    };
}> | undefined): Map<string, SizeConversion> | undefined;
/**
 ...
 */
export declare function buildDimensionalPlan(decl: BoundingBoxDeclaration | undefined, extraSizeProps?: Map<string, SizeConversion>): DimensionalPlan | null;
/**
 ...
 */
export declare function boxHalfExtentsUV(decl: BoundingBoxDeclaration | undefined, props: Record<string, any>, width: number, height: number): {
    hwx: number;
    hhy: number;
};
/**
 ...
 */
export declare function resolveDimensionalProps(decl: BoundingBoxDeclaration | undefined, rawProps: Record<string, any>, width: number, height: number, extraSizeProps?: Map<string, SizeConversion>): Record<string, any>;
/**
 ...
 */
export declare function resolveDimensionalProp(decl: BoundingBoxDeclaration | undefined, propName: string, rawValue: any, origin: BoundingBoxOrigin, width: number, height: number, extraSizeProps?: Map<string, SizeConversion>, he?: {
    hwx: number;
    hhy: number;
}): any;
/** Whether a prop is a dimensional (position/size) prop for the given declaration. */
export declare function isDimensionalProp(decl: BoundingBoxDeclaration | undefined, propName: string, extraSizeProps?: Map<string, SizeConversion>): boolean;
/** Convenience: the set of all dimensional prop names for a declaration. */
export declare function dimensionalPropNames(decl: BoundingBoxDeclaration | undefined, extraSizeProps?: Map<string, SizeConversion>): string[];
export type { ComponentDefinition };
//# sourceMappingURL=dimensionalProps.d.ts.map