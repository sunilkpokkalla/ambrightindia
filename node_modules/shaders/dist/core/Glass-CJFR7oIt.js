import { I as createGaussianBlurCompute, Ot as ZERO, T as sdf_exports, d as sdf3d_exports } from "./coords-BlwgBpJf.js";
import { n as glass_exports } from "./glass-DdgMBWkF.js";
import { a as transformColor, c as transformPosition, i as transformBoolean } from "./transformations-fqzznt4g.js";
...
const componentDefinition = {
	...
	compute: (params) => {
		...
		const root = gpu?.root;
		const fieldResult = createVolumetricFieldComputeNode(params, () => getCpuValue("shape"), "none");
		let blurResult = null;
	...
	fragment: (params) => {
		...
		}).volumetricFieldSampler, childTexture, blurredTexture, { volumetric: true });
