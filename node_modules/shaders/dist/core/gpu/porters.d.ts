import { Expr, GpuShaderDefinition } from './contract';
/**
...
export { expr, floatE, call, vec4, mixExpr, arrayExpr, ZERO, WHITE0 } from './composer';
export { createGuardedCompute, type ComputeStep, type KitComputePipeline } from './compute';
export { createStateBuffer, createPingPong, type PingPong } from './compute';
/**
 ...
 */
export declare const rootPassthrough: GpuShaderDefinition;
/**
 ...
 */
export declare function animatedTime(params: {
    props: Expr;
    uniforms: Record<string, Expr>;
}, seedName?: string, fieldName?: string): Expr;
//# sourceMappingURL=porters.d.ts.map