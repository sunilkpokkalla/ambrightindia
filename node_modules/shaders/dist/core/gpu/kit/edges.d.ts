import { d } from './index';
import { v2f, v4f } from 'typegpu/data';
import { Expr } from '../contract';

/** Stretch (mode 0): clamp UV into [0,1] (`clamp(uv, vec2(0), vec2(1))`). */
export declare const edgeClampUV: import('typegpu').TgpuFn<(uv: d.Vec2f) => d.Vec2f>;
/**
 ...
 */
export declare const edgeMirrorUV: import('typegpu').TgpuFn<(uv: d.Vec2f) => d.Vec2f>;
/** Wrap (mode 3): tile UV via `fract(uv)`. */
export declare const edgeWrapUV: import('typegpu').TgpuFn<(uv: d.Vec2f) => d.Vec2f>;
/**
 ...
 */
export declare const edgeTransparentMask: import('typegpu').TgpuFn<(uv: d.Vec2f) => d.F32>;
/**
 ...
 */
export declare const applyEdgeToUV: (uv: v2f, edgeMode: number) => v2f;
/**
 ...
 */
export declare const composeEdgeRemap: (distortedUV: v2f, mask: number, edgeMode: number) => {
    uv: v2f;
    mask: number;
};
/**
 ...
 */
export declare const applyEdgeHandling: (distortedUV: v2f, sampledColor: v4f, sample: ((uv: v2f) => v4f) | null, edgeMode: number) => v4f;
/**
 ...
 */
export declare const applyEdgeToUVExpr: (uv: Expr, edgeMode: number) => Expr;
/**
 ...
 */
export declare const composeEdgeRemapExpr: (distortedUV: Expr, mask: Expr, edgeMode: number) => {
    uv: Expr;
    mask: Expr;
};
/**
 ...
 */
export declare const applyEdgeHandlingExpr: (distortedUV: Expr, sample: (uv: Expr) => Expr, edgeMode: number) => Expr;
