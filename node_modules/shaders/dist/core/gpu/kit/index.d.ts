import { default as tgpu } from 'typegpu';
import { AnyVecInstance, AnyWgslData } from 'typegpu/data';
 ...
 */
export declare function oneMinus(x: number): number;
export declare function oneMinus<T extends AnyVecInstance>(x: T): T;
/**
 ...
 */
export declare function select(cond: boolean, ifTrue: boolean, ifFalse: boolean): boolean;
export declare function select(cond: boolean, ifTrue: number, ifFalse: number): number;
export declare function select<T extends AnyVecInstance>(cond: boolean | AnyVecInstance, ifTrue: T, ifFalse: T): T;
/**
 * Squared length of a vector, `dot(v, v)` — cheaper than `length` when only comparing
 * magnitudes.
 */
export declare function lengthSq(v: AnyVecInstance): number;
