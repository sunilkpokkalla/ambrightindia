import { d } from './index';
import { BoundingBoxConfig } from '../../types';
 ...
 */
export declare const applyUVTransform: import('typegpu').TgpuFn<(uv: d.Vec2f, offsetX: d.F32, offsetY: d.F32, rotation: d.F32, scale: d.F32, anchorX: d.F32, anchorY: d.F32, aspectRatio: d.F32) => d.Vec2f>;
/**
 ...
 */
export declare const applyInverseUVTransform: import('typegpu').TgpuFn<(uv: d.Vec2f, offsetX: d.F32, offsetY: d.F32, rotation: d.F32, scale: d.F32, anchorX: d.F32, anchorY: d.F32, aspectRatio: d.F32) => d.Vec2f>;
/**
 ...
 */
export declare const boundingBoxToUVParams: (bbox: BoundingBoxConfig, canvasWidth: number, canvasHeight: number) => BoundingBoxUVParams;
/**
 * Returns 1 inside the rotated bounding-box rectangle, 0 outside (rounded-rect SDF, hard
 * edges). Rotation is aspect-corrected. The screen UV is the explicit `uv` arg.
 */
export declare const applyRectangularClipMask: import('typegpu').TgpuFn<(uv: d.Vec2f, centerX: d.F32, centerY: d.F32, halfWidth: d.F32, halfHeight: d.F32, cornerRadius: d.F32, rotation: d.F32, aspectRatio: d.F32) => d.F32>;
/**
 ...
 */
export declare const boundingBoxToGeneratorUVContext: import('typegpu').TgpuFn<(uv: d.Vec2f, centerX: d.F32, centerY: d.F32, halfWidth: d.F32, halfHeight: d.F32, rotation: d.F32, aspectRatio: d.F32) => d.Vec2f>;
/**
 ...
 */
export declare const screenUVToBoxLocal: (sx: number, sy: number, g: BoxLocalGeometry) => {
    x: number;
    y: number;
};
/** Box-local fraction [0,1] (Y-down) → screen-UV point (Y-down). Inverse of screenUVToBoxLocal. */
export declare const boxLocalToScreenUV: (bx: number, by: number, g: BoxLocalGeometry) => {
    x: number;
    y: number;
};
