import { d } from './index';
import { InferInput } from 'typegpu/data';
...
import { Expr, GpuFragmentParams, KitTexture, GpuComputeStep } from '../contract';
...
export declare function rotateVecCpu(vx: number, vy: number, vz: number, s: {
    cx: number;
    sx: number;
    cy: number;
    sy: number;
...
/** Sphere: `|p| - r`. */
export declare const sdSphere: import('typegpu').TgpuFn<(p: d.Vec3f, r: d.F32) => d.F32>;
/** Rounded box: half-extents (hx,hy,hz), corner rounding. */
export declare const sdRoundBox: import('typegpu').TgpuFn<(p: d.Vec3f, hx: d.F32, hy: d.F32, hz: d.F32, rounding: d.F32) => d.F32>;
/** Torus: ring radius `ringR` (in xz), tube radius `tubeR` (about y). */
export declare const sdTorus: import('typegpu').TgpuFn<(p: d.Vec3f, ringR: d.F32, tubeR: d.F32) => d.F32>;
/** Octahedron (iq, bound version): scaled L1 distance — Lipschitz-safe with the march's
 *  min-step guard. */
export declare const sdOctahedron: import('typegpu').TgpuFn<(p: d.Vec3f, s: d.F32) => d.F32>;
/** Rounded cylinder: radius `r`, half-height `h`, corner rounding. */
export declare const sdRoundCylinder: import('typegpu').TgpuFn<(p: d.Vec3f, r: d.F32, h: d.F32, rounding: d.F32) => d.F32>;
/** Capsule: radius `r`, half-height `h` (about y). */
export declare const sdCapsule: import('typegpu').TgpuFn<(p: d.Vec3f, r: d.F32, h: d.F32) => d.F32>;
export declare const sdCappedCone: import('typegpu').TgpuFn<(p: d.Vec3f, r1: d.F32, r2: d.F32, h: d.F32) => d.F32>;
export declare const sdPyramid: import('typegpu').TgpuFn<(p: d.Vec3f, b: d.F32, ht: d.F32) => d.F32>;
export declare const sdHexPrism: import('typegpu').TgpuFn<(p: d.Vec3f, r: d.F32, he: d.F32) => d.F32>;
export declare const sdEllipsoid: import('typegpu').TgpuFn<(p: d.Vec3f, rx: d.F32, ry: d.F32, rz: d.F32) => d.F32>;
export declare const sdBicone: import('typegpu').TgpuFn<(p: d.Vec3f, r: d.F32, h: d.F32) => d.F32>;
export declare const sdLink: import('typegpu').TgpuFn<(p: d.Vec3f, le: d.F32, r1: d.F32, r2: d.F32) => d.F32>;
export declare const smin: import('typegpu').TgpuFn<(a: d.F32, b: d.F32, k: d.F32) => d.F32>;
export declare const sdGem: import('typegpu').TgpuFn<(p: d.Vec3f, r: d.F32, h: d.F32, sides: d.F32) => d.F32>;
export declare const sdHelix: import('typegpu').TgpuFn<(p: d.Vec3f, R: d.F32, tube: d.F32, pitch: d.F32, turns: d.F32) => d.F32>;
export declare const sdMetaballs: import('typegpu').TgpuFn<(p: d.Vec3f, b0: d.Vec3f, b1: d.Vec3f, b2: d.Vec3f, b3: d.Vec3f, r: d.F32, k: d.F32) => d.F32>;
export declare const sdDodecahedron: import('typegpu').TgpuFn<(p: d.Vec3f, r: d.F32) => d.F32>;
export declare const sdCutSphere: import('typegpu').TgpuFn<(p: d.Vec3f, r: d.F32, h: d.F32) => d.F32>;
export declare const sdRibbon: import('typegpu').TgpuFn<(p: d.Vec3f, w: d.F32, th: d.F32, len: d.F32, amp: d.F32, freq: d.F32, ph1: d.F32, ph2: d.F32, twRate: d.F32, twPh: d.F32, lip: d.F32) => d.F32>;
export declare const sdWobbleBlob: import('typegpu').TgpuFn<(p: d.Vec3f, r: d.F32, amp: d.F32, freq: d.F32, ph1: d.F32, ph2: d.F32, lip: d.F32) => d.F32>;
export declare const sdFlatBand: import('typegpu').TgpuFn<(radialDist: d.F32, axialDist: d.F32, R: d.F32, ht: d.F32, hw: d.F32, rnd: d.F32) => d.F32>;
export declare const sdGyroscope: import('typegpu').TgpuFn<(p: d.Vec3f, radius: d.F32, width: d.F32, thick: d.F32, rnd: d.F32, core: d.F32, c1: d.F32, s1: d.F32, c2: d.F32, s2: d.F32, c3: d.F32, s3: d.F32) => d.F32>;
/** CPU-precomputed sin/cos rotation, passed to the march as one struct argument (ZXY Euler). */
export declare const RotStruct: d.WgslStruct<{
    cx: d.F32;
    sx: d.F32;
    cy: d.F32;
    sy: d.F32;
...
export declare const rotateVec3: import('typegpu').TgpuFn<(v: d.Vec3f, rot: d.WgslStruct<{
    cx: d.F32;
    sx: d.F32;
    cy: d.F32;
    sy: d.F32;
 ...
 */
export declare function buildRaymarchedFieldFn(sdfFn: BakedSdf, patternMode?: SurfacePatternMode): import('typegpu').TgpuFn<(fuv: d.Vec2f, rot: d.WgslStruct<{
    cx: d.F32;
    sx: d.F32;
    cy: d.F32;
    sy: d.F32;
...
export declare function buildRaymarchedField(sdfFn: BakedSdf, patternMode?: SurfacePatternMode): import('typegpu').TgpuFn<(fuv: d.Vec2f, rot: d.WgslStruct<{
    cx: d.F32;
    sx: d.F32;
    cy: d.F32;
    sy: d.F32;
...
export declare const VOLUMETRIC_FIELD_FORMAT: "rgba32float";
...
export declare const VOLUMETRIC_FIELD_RES = 1536;
...
export declare const VOLUMETRIC_FIELD_RES_MOBILE = 768;
/**
 ...
 */
export declare function resolveVolumetricFieldRes(): number;
/**
 ...
 */
export declare function resolveActiveFieldRes(spanXv: number, spanYv: number, scale: number, canvasHeightDevicePx: number, maxRes: number, prevRes: number): number;
/**
 * March-pass uniform. Holds the rotation, bounding radius, aspect-fit domain (span/origin), active
 * resolution, AND the shape's size superset (pA..pD + four metaball centres) so the caller's
 * baked `sdfFn` reads its params from `layout.$.params.pA` etc. It is a superset; unused fields are
 * never read by the shape's kernel. (The consumer's per-frame CPU setup writes this each time the
 * shape state changes — see CONSUMER WIRES.)
 */
export declare const MarchParams: d.WgslStruct<{
    rot: d.Decorated<d.WgslStruct<{
        cx: d.F32;
        sx: d.F32;
        cy: d.F32;
        sy: d.F32;
 ...
 */
export declare function makeVolumetricFieldLayout(): {
 ...
 */
export declare function buildVolumetricFieldKernel(layout: VolumetricFieldLayout, marchFn: ReturnType<typeof buildRaymarchedFieldFn>): import('typegpu').TgpuFn<(cx: d.U32, cy: d.U32) => d.Void>;
/**
 ...
 */
export declare const SampleParams: d.WgslStruct<{
    originX: d.F32;
    originY: d.F32;
    spanX: d.F32;
    spanY: d.F32;
 ...
 */
export declare function buildFieldSampleGraph(): {
    sampleLayout: import('typegpu').TgpuBindGroupLayout<{
        field: {
    ...
    fieldSample: import('typegpu').TgpuFn<(uv: d.Vec2f) => d.Vec4f>;
    fieldSampleFast: import('typegpu').TgpuFn<(uv: d.Vec2f) => d.Vec4f>;
    SampleParams: d.WgslStruct<{
        originX: d.F32;
        originY: d.F32;
        spanX: d.F32;
        spanY: d.F32;
...
export declare function createVolumetricFieldCompute(root: TgpuRoot, layout: VolumetricFieldLayout, kernel: ReturnType<typeof buildVolumetricFieldKernel>, onCleanup: (cb: () => void) => void, extra?: VolumetricFieldComputeExtra): VolumetricFieldCompute;
/**
 ...
 */
export declare function makeVolumetricSvgFieldLayout(): {
    layout: import('typegpu').TgpuBindGroupLayout<{
        field: {
            storageTexture: d.WgslStorageTexture2d<"rgba32float", string>;
        };
 ...
 */
export declare function buildFieldSampleGraphArgs(): {
    fieldSampleArg: import('typegpu').TgpuFn<(uv: d.Vec2f, field: d.WgslTexture2d<d.F32>, originX: d.F32, originY: d.F32, spanX: d.F32, spanY: d.F32, activeResF: d.F32, rBound: d.F32) => d.Vec4f>;
    fieldSampleFastArg: import('typegpu').TgpuFn<(uv: d.Vec2f, field: d.WgslTexture2d<d.F32>, originX: d.F32, originY: d.F32, spanX: d.F32, spanY: d.F32, activeResF: d.F32, rBound: d.F32) => d.Vec4f>;
    texelSpanFn: import('typegpu').TgpuFn<(spanX: d.F32, spanY: d.F32, activeResF: d.F32) => d.F32>;
};
/**
 ...
 */
export declare const VOLUMETRIC_FIELD_EXTRA_FIELDS: Record<string, {
    schema: typeof d.f32;
    initial: number;
}>;
...
/** The three field-sampler Exprs a shape-effect fragment consumes. */
 ...
 */
export declare function buildVolumetricFieldSampler(field: KitTexture, p: VolumetricFieldSampleParams): VolumetricFieldSamplers;
 ...
 */
export declare function createAnalytic3dSdfSetup(root: TgpuRoot, shapeType: string, initialConfig: Record<string, unknown>, getShapeConfig: () => unknown): VolumetricFieldSetup;
/**
 ...
 */
export declare function createSvg3dSdfSetup(params: GpuFragmentParams, shapeSdfUrl: string, getShapeConfig: () => unknown): VolumetricFieldSetup;
/**
 ...
 */
export declare function createVolumetricFieldComputeNode(params: GpuFragmentParams, getShapeConfig: () => unknown, patternMode?: SurfacePatternMode): {
    outputs: {
        volumetricFieldTexture: KitTexture;
    };
    getComputeNodes: (frameParams?: ShapeFrameParams) => GpuComputeStep[] | null;
