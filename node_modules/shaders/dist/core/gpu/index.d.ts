...
export { acquireRoot, configureCanvasContext, getRootForDevice } from './root';
...
export declare function shaderRendererGPU(): {
    ...
    renderSyntheticFrame: (deltaSeconds: number) => Promise<void>;
