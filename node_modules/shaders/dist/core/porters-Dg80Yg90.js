import { Nt as expr, _t as packConvertedStops, pt as MAX_COLOR_STOPS, vt as packStops } from "./coords-CWOT0Wqh.js";
import { a as transformColor, c as transformPosition, n as setColorSpaceMode, o as transformColorSpace, u as Color } from "./transformations-fqzznt4g.js";
...
function parseColorChannelsGpu(value) {
	try {
		...
		return {
			...
			a: Number.isFinite(parsed.alpha) ? parsed.alpha : 0
		};
	} catch {
		return {
			r: 0,
