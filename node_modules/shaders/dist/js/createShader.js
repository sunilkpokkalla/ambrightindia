import { createGpuUniformsMap, resolveBoundingBox, rootPassthrough, shaderRendererGPU } from "../core/index.js";
		...
		if (isExternalUser()) {
			const checkRendering = () => {
				...
				if (renderer.getPerformanceStats().fps > 0) {
					state.telemetryCollector = startTelemetry(renderer, "3.0.439", options?.disableTelemetry || false, false);
