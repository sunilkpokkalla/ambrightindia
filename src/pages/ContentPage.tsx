      ...
      <div className="bg-[#EFEFEF]">
        ...
        <div className="mx-auto grid w-full max-w-[1440px] grid-cols-1 items-center gap-10 px-5 pb-14 pt-10 sm:px-8 sm:pb-16 sm:pt-14 lg:grid-cols-[1fr_42%] lg:gap-14 lg:px-12 lg:pb-20 lg:pt-16">
          <div>
            ...
            <p className="mt-5 max-w-[720px] text-[15px] leading-[1.7] text-gray-600 sm:mt-6 sm:text-[17px]">
              {page.intro}
            </p>
          </div>
          {page.image && (
            ...
            <div className="grid grid-cols-1 gap-4 md:grid-cols-2 lg:grid-cols-3 sm:gap-5">
              {page.links.map((l) => (
                <Link
                  key={l.to}
                  to={l.to}
                  className="group flex flex-col gap-2 rounded-2xl bg-white p-6 transition-shadow duration-300 hover:shadow-[0_4px_16px_rgba(0,0,0,0.08)]"
                >
