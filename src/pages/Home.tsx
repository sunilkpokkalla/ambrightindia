        ...
        <div className="grid grid-cols-1 gap-5 px-5 md:grid-cols-2 lg:grid-cols-3 sm:gap-6 sm:px-8 lg:px-12">
          {EXPLORE.map((e) => (
            <Link
              key={e.to}
              to={e.to}
              className="group flex flex-col overflow-hidden rounded-2xl border border-gray-200 transition-shadow duration-300 hover:shadow-[0_4px_16px_rgba(0,0,0,0.08)]"
            >
              <img
                src={e.img}
                alt={e.label}
        ...
        <div className="grid grid-cols-1 gap-5 px-5 md:grid-cols-3 sm:gap-6 sm:px-8 lg:px-12">
          {latest.map((p) => (
            <Link
              key={p.path}
              to={p.path}
              className="group flex flex-col overflow-hidden rounded-2xl border border-gray-200 bg-white transition-shadow duration-300 hover:shadow-[0_4px_16px_rgba(0,0,0,0.08)]"
            >
              {p.image && (
                <img
                  src={p.image}
