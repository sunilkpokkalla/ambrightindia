...
export const POSTS: Post[] = [
  ...
  },
  {
    ...
    category: 'News',
    title:
      'AmBrightTech’s Founder, Sunil Pokkalla, Aims for Global Expansion to Empower Small Businesses in the IT Industry',
    excerpt:
      'Founder Sunil Pokkalla shares his vision: growing AmBrightTech into a global firm while keeping small businesses — the overlooked engine of IT innovation — at the center.',
    body: [
      'AmBrightTech founder Sunil Pokkalla has set an ambitious course for the company: expand its consulting and workforce solutions globally, while staying relentlessly focused on the businesses that big firms overlook.',
      '"Small businesses drive the IT industry’s innovation, but they rarely get enterprise-grade support," Pokkalla says. "The big consultancies price them out. The talent platforms leave them to fend for themselves. Our goal is to give them the same quality of talent and consulting that Fortune 500 companies take for granted — at a scale and a price that actually fits."',
      'It is a conviction born of experience. Pokkalla built AmBrightTech from the ground up in Texas, learning firsthand how much harder every hire, every platform decision and every growth spurt is when nobody with deep expertise is in your corner. That memory is now company strategy: be the partner we wished we had.',
      ...
      'Global scale, Pokkalla insists, will never mean losing the personal signature. "The moment a client feels like an account number, we have failed. The plan is simple to say and hard to do: grow the reach, keep the care. Every market we enter, we enter the way we started in Texas — one relationship at a time."',
