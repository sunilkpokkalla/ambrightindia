...
const PRODUCTS: Product[] = [
  {
    ...
    name: 'TalentBridge',
    theme: 'people',
    tagline: 'The staffing platform we wished existed — so we built it.',
    intro:
      'TalentBridge is our in-house talent platform: candidate matching, practitioner-scored screening and placement tracking in one system, born from thousands of real placements.',
    what: 'AI-assisted matching that ranks candidates on evidence, structured screening scorecards designed by our practice leads, and a placement pipeline that keeps candidates informed at every step — because silence is the worst answer in hiring.',
    points: [
      'AI-assisted candidate-role matching',
      'Practitioner-designed screening scorecards',
      'Automated candidate communication',
      'Placement analytics and quality tracking',
    ],
    status:
      'TalentBridge powers AmBrightTech’s own workforce solutions today and is being prepared for early-access partners. Staffing firms and internal recruiting teams interested in the pilot can register interest through our contact page.',
  },
  {
    slug: 'brightboard',
    name: 'BrightBoard',
    theme: 'chart',
    tagline: 'One dashboard your whole leadership team believes.',
    intro:
      'BrightBoard is our business analytics product for small and mid-size companies: pre-built data models, connected sources and executive dashboards live in days — not the quarter your last BI project took.',
    what: 'Connectors for the systems SMBs actually run, curated metric definitions so "revenue" means one thing, and dashboards designed for decisions rather than decoration.',
    points: [
      'Prebuilt connectors and data models',
      'Curated, consistent metric definitions',
      'Executive and operational dashboard packs',
      'Alerting on the numbers that move',
    ],
    status:
      'BrightBoard grew out of our Data & Analytics practice and runs with pilot customers today. It is available through consulting engagements while the self-service edition matures in Labs.',
  },
  {
    slug: 'pulsedesk',
    name: 'PulseDesk',
    theme: 'shield',
    tagline: 'Support software with a heartbeat.',
    intro:
      'PulseDesk is our AI-augmented helpdesk for lean IT teams: intelligent ticket triage, knowledge-grounded suggested resolutions and escalation that never loses the thread.',
    what: 'Tickets arrive classified and prioritized, common issues get AI-drafted resolutions grounded in your runbooks, and every escalation carries full context — so small teams support like big ones.',
    points: [
      'AI ticket triage and prioritization',
      'Runbook-grounded suggested resolutions',
      'Context-preserving escalations',
      'Trend analytics that surface root causes',
    ],
    status:
      'PulseDesk is in active development in AmBrightTech Labs, dogfooded by our own managed-services team. Early-access slots open to managed-IT clients first.',
  },
  {
    slug: 'cloudlens',
    name: 'CloudLens',
    theme: 'cloud',
    tagline: 'See exactly where your cloud bill goes — and stop the leaks.',
    intro:
      'CloudLens is our cloud cost intelligence tool: continuous scanning of your AWS and Azure accounts for waste, rightsizing recommendations with dollar figures attached, and guardrails that keep costs fixed.',
    what: 'It finds the oversized instances, orphaned storage and forgotten environments hiding in your bill, ranks fixes by savings and effort, and tracks realized savings so finance sees the receipts.',
    points: [
      'Continuous waste and anomaly scanning',
      'Rightsizing recommendations with dollar impact',
      'Savings tracking and finance-ready reporting',
      'Budget guardrails and alerts',
    ],
    status:
      'CloudLens began as the internal tooling behind our Cloud practice’s FinOps reviews. It is offered today as part of cloud engagements, with a standalone edition on the Labs roadmap.',
  },
  {
    slug: 'hirewise',
    name: 'HireWise',
    theme: 'target',
    tagline: 'Interview intelligence for teams that hire rarely but must hire right.',
    intro:
      'HireWise helps non-recruiters run great technical hiring: structured interview kits, calibrated scoring and AI-assisted screening summaries — the discipline of a big-company process without the bureaucracy.',
    what: 'Role-specific interview kits designed by our practice leads, structured scorecards that fight bias, and candidate summaries that turn scattered feedback into a clear decision.',
    points: [
      'Practitioner-designed interview kits by role',
      'Structured, calibrated scorecards',
      'AI-assisted screening summaries',
      'Decision dashboards for hiring committees',
    ],
    status:
      'HireWise distills the screening methodology behind our direct-hire practice. In pilot with select clients; join the waitlist through our contact page.',
  },
]
...
const HUBS: PageDef[] = [
  ...
  },
  {
    ...
    intro:
      'AmBrightTech Labs builds in-house products the same way we advise clients to: problem first, prototype fast, measure honestly, and only scale what earns it. These five made it through the gauntlet.',
    image: img('lab'),
    ...
    sections: [
      ...
      },
      {
        ...
        body: 'Behind these five sit the prototypes that did not make it — and we are proud of those too. A disciplined "no" after three weeks is a Labs success story. Read "Building Digital Products That Solve Real Problems" for the method behind the portfolio.',
      },
    ],
    cta: { label: 'Request early access', to: '/contact' },
  },
