        ...
        <div className="px-5 sm:px-8 lg:hidden">
          ...
          <div className="mt-10 flex flex-col gap-4 sm:flex-row sm:gap-5">
            <img
              ...
              className="w-full rounded-xl object-cover aspect-[438/346] sm:w-[45%] sm:rounded-2xl"
            />
            <img
              src={IMG_LARGE}
              alt="AmBrightTech consultants collaborating"
              className="w-full rounded-xl object-cover aspect-[900/600] sm:w-[55%] sm:rounded-2xl"
            />
          </div>
        </div>
