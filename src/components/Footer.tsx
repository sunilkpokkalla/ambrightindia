          ...
          <div className="max-w-[320px]">
            <Link to="/" className="flex items-center gap-3">
              <span className="flex h-10 w-10 items-center justify-center rounded-full bg-gray-900">
                <img src="/images/logo-white.svg" alt="AmBrightTech" className="h-6 w-6" />
              </span>
            ...
            <a
              ...
              target="_blank"
              rel="noreferrer"
              className="mt-4 block text-[13px] leading-relaxed text-gray-600 transition-colors duration-300 hover:text-gray-900"
            >
              7300 State Highway 121<br />
              3rd Floor, Suite 300<br />
              McKinney, Texas 75070
            </a>
            <a
              href="tel:+14693106281"
              className="mt-3 block text-[13px] font-medium text-gray-900 transition-colors duration-300 hover:text-gray-500"
            >
              +1 (469) 310 6281
            </a>
            <p className="mt-1 text-[12px] text-gray-500">9 AM – 5 PM CST</p>
